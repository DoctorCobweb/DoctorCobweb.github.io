...
The 2nd half of 2018 saw practically no running at all. Instead there was loads of road and mountain bike riding. Rides consistently had at least 500m of vertical gain, peaking at a single week having 400kms with ~12500m of vertical ascent due to partaking in the Pioneer MTB Race in New Zealand. That's incredible. Riding predominantly builds strength in the major muscle groups (quads, calves etc), as opposed to the smaller, stabalizer-like muscles commonly associated with running on trails. Trail running still needs raw base-level strength coming from the major muscle groups and riding provides another avenue towards achieving this, albeit with reduced risk of injury due to the zero impact nature of riding. It seems like this principle is manifest here.

Swimming increases concurrently with running volume. This suggests that swimming is being used as a form of active recovery in exchange for running more and riding less. Since there's some amount of overlap with respect to running and riding, reducing one when the other increases seems like a logical thing to do. 

Justin had a consistent build in running volume starting in January. The only other athlete to display this type of consitent build was Jonathan O'Loughlin. All other runners had peaks and troughs characteristic of distinct training blocks. Nearing UTA, the intensity of training really ramped up with Justin participating in 3 trail events within a space of 4-8 weeks. One event saw Justin compete in a 22km trail event then turn back and run back to the start line. These types of long runs at intensity not only benefit the physical side but also the mental. Turning back to 'do it all again' requires a certain amount of mental resilience, crucial for the longer events like UTA 100km.
